...
class DataLoaderLite:
    ...
    def next_batch(self):
        ...
        # if self.current_position + (B * T * self.num_processes + 1) > len(self.tokens): Bug in train_gpt2.py?
...
# simple launch:
# python train_gpt_instruct.py
# DDP launch for e.g. 8 GPUs:
# torchrun --standalone --nproc_per_node=8 train_gpt_instruct.py
master_process = True
ddp = None
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Load the pre-trained GPT2(124M) model
        print(f"Loading pretrained model: gpt2")
